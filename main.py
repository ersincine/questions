import os
import shutil
from utils import read_templates, standardize_padding, find_correct_scale, find_letter_bboxes, align_rows
import cv2 as cv
...
if __name__ == "__main__":
    ...
    for question_filename in question_filenames:
        ...
        img = standardize_padding(img, padding=5)
